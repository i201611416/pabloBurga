 ...
 */
public abstract class Hilt_RecoverFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecoverFragment() {
    super();
  }

  Hilt_RecoverFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecoverFragment_GeneratedInjector) this.generatedComponent()).injectRecoverFragment(UnsafeCasts.<RecoverFragment>unsafeCast(this));
    }
  }
