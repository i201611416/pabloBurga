 ...
 */
public abstract class Hilt_DeletedFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DeletedFragment() {
    super();
  }

  Hilt_DeletedFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DeletedFragment_GeneratedInjector) this.generatedComponent()).injectDeletedFragment(UnsafeCasts.<DeletedFragment>unsafeCast(this));
    }
  }
