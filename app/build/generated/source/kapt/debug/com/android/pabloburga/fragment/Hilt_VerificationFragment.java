 ...
 */
public abstract class Hilt_VerificationFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_VerificationFragment() {
    super();
  }

  Hilt_VerificationFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((VerificationFragment_GeneratedInjector) this.generatedComponent()).injectVerificationFragment(UnsafeCasts.<VerificationFragment>unsafeCast(this));
    }
  }
